...
const eula = async(client,message) => {
    ...
    const menfessSessionHandle = require("./menfess/menfess-session-handle");
    ...
    switch(command){
        ...
        case trigger+"hiddenmenu":
            ...
            client.sendMessage("*"+namaBot+"*\n62895395391278@c.us","User "+dataPengirim['nama']+" dengan nomor "+dataPengirim['nomor']+" request Hidden Menu")
        break;
        //Admin Menu
        ...
        case trigger+"bacot":
            ...
            if(res != false){
                const pesan = "*"+namaBot+"*\n\n"+res.result;
                await logfitur(nomor, namaPengirim, "Bacot", groupname, false);
                chat.sendMessage(pesan);
            }else{
        ...
        case trigger+"katabijak":
            ...
            if(res != false){
                const pesan = "*"+namaBot+"*\n\n"+res.quotes+"\n- "+res.author;
                await logfitur(nomor, namaPengirim, "Kata Bijak", groupname, false);
                chat.sendMessage(pesan);
            }else{
                chat.sendMessage(namaBot+"\n\n"+fiturError);
            }
        ...
        case trigger+"katailham":
            ...
            if(res != false){
                const pesan = "*"+namaBot+"*\n\n"+res.result;
                await logfitur(nomor, namaPengirim, "Kata Ilham", groupname, false);
                chat.sendMessage(pesan);
            }else{
                chat.sendMessage(namaBot+"\n\n"+fiturError);
            }
        ...
        case trigger+"pantunpakboy":
            ...
            if(res != false){
                const pesan = "*"+namaBot+"*\n\n"+res.result;
                await logfitur(nomor, namaPengirim, "Pantun Pak boy", groupname, false);
                chat.sendMessage(pesan);
            }else{
                chat.sendMessage(namaBot+"\n\n"+fiturError);
            }
        ...
        case trigger+"sindiran":
            ...
            if(res != false){
                const pesan = "*"+namaBot+"*\n\n"+res.result;
                await logfitur(nomor, namaPengirim, "Sindiran", groupname, false);
                chat.sendMessage(pesan);
            }else{
                chat.sendMessage(namaBot+"\n\n"+fiturError);
            }
